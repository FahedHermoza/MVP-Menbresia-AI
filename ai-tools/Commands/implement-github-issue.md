...
---
1. Recibe los parámetros `ISSUE_LINK` y `SPEC_DIR` del usuario. Si no los proporciona en el comando, pídeselos antes de continuar.
...
3. Revisa y asimila los lineamientos del proyecto ubicados en:
    ...
    - [MVP-MenbresiaAI/screens](cci:7://file:///Users/fae/Documents/GitHub-World/GitHub/CursoAIExpert/MVP-Project/MVP-MenbresiaAI/screens:0:0-0:0)
...
5. Implementa el requerimiento descrito en el issue `ISSUE_LINK`, asegurándote de completar secuencialmente todas las tareas listadas en el `tasks.md`.
...
@implement-github-issue.md ISSUE_LINK="https://github.com/FahedHermoza/MVP-Menbresia-AI/issues/3" SPEC_DIR="MVP-MenbresiaAI/spec/auth"
